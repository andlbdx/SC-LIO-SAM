...
public:
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imuMsg)
    {
        ...
        // if(thisImu.linear_acceleration.z < 0){
        //     thisImu.linear_acceleration.z  = -thisImu.linear_acceleration.z ;
        // }
        
        std::lock_guard<std::mutex> lock1(imuLock);
        imuQueue.push_back(thisImu);
        // ROS_INFO("imuQueue data size %s",imuQueue.size());
    ...
    bool deskewInfo()
    {
        ...
        if(imuQueue.front().header.stamp.toSec() > timeScanCur){
            ROS_INFO("%lf, %lf", imuQueue.front().header.stamp.toSec(), timeScanCur);
    ...
    void projectPointCloud()
    {
        ...
        cout << "point cloud size " + cloudSize << endl;
